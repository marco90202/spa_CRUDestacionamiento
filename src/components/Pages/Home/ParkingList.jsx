                                                            ...
                                                            <div htmlFor={c.id} className="col-md-4 col-sm-4 col-xs-3">
                                                                ...
                                                                <div htmlFor={c.id} className="post_list_featured_image"> 
                                                                        <div htmlFor={c.id} className="stm_lms_lazy_image stm_lms_lazyloaded stm_lms_lazy_image__lazyloaded">
                                                                           {c.status === "libre" ? <img width="140" height="125" data-src="https://www.iconsdb.com/icons/preview/guacamole-green/circle-xxl.png" className="img-responsive wp-post-image lazyloaded" alt={c.status} src="https://www.iconsdb.com/icons/preview/guacamole-green/circle-xxl.png" /> : <img width="125" height="125" data-src="https://www.iconsdb.com/icons/preview/soylent-red/circle-xxl.png" className="img-responsive wp-post-image lazyloaded" alt={c.status} src="https://www.iconsdb.com/icons/preview/soylent-red/circle-xxl.png" /> }
                                                                        </div> 
                                                                </div>
                                                                <div className="row">
                                                                    <div className="col-md-12">
